...
#Region "Inventario producto"
    ...
    Private Sub btVentaGeneral_Click(sender As Object, e As EventArgs) Handles btVentaGeneral.Click
        SideNav1.IsMenuExpanded = False
        FP_Ventana.Select()
        Dim frm As New R01_VentaGeneral
        Dim tab3 As SuperTabItem = superTabControlVentana.CreateTab(frm.Text)
        frm._nameButton = R01_VentaGeneral.Name
        frm._tab = tab3
        frm._modulo = FP_Venta
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
        superTabControlVentana.SelectedTabIndex = superTabControlVentana.Tabs.Count - 1
