...
#Region "Metodos"
    ...
    Private Sub _PCargarDetalle(idTipoProd As String)
        ...
        For i = 0 To dtProd.Rows.Count - 1
            ...
            dtPreciosProd = ObtenerCategoriaPrecio(dtProd.Rows(i).Item("canumi"))
    ...
    Function ObtenerCategoriaPrecio(numiProducto As Integer) As DataTable
        Dim dt As DataTable = dtPrecios.Copy
        Dim Precios As DataTable = dtPrecios.Copy
        dt.Rows.Clear()

        For i As Integer = 0 To Precios.Rows.Count - 1 Step 1
            If (Precios.Rows(i).Item("chcprod") = numiProducto) Then

                dt.ImportRow(Precios.Rows(i))
