...
Partial Public Class BDDistBHFEntities
    ...
    Public Overridable Function PlanillaSueldo(fecha As Nullable(Of Date)) As ObjectResult(Of PlanillaSueldo_Result)
        ...
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of PlanillaSueldo_Result)("PlanillaSueldo", fechaParameter)
    End Function
    ...
    Public Overridable Function sp_go_Reportes(tipo As Nullable(Of Integer), cprod As String, fini As Nullable(Of Date), ffin As Nullable(Of Date), codigo As String, cliente As String, proveedor As String, fechaI As Nullable(Of Date), fechaF As Nullable(Of Date), ban As Nullable(Of Integer), anho As Nullable(Of Integer), mes As Nullable(Of Integer)) As ObjectResult(Of sp_go_Reportes_Result)
        Dim tipoParameter As ObjectParameter = If(tipo.HasValue, New ObjectParameter("tipo", tipo), New ObjectParameter("tipo", GetType(Integer)))
        ...
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of sp_go_Reportes_Result)("sp_go_Reportes", tipoParameter, cprodParameter, finiParameter, ffinParameter, codigoParameter, clienteParameter, proveedorParameter, fechaIParameter, fechaFParameter, banParameter, anhoParameter, mesParameter)
    End Function
    ...
    Public Overridable Function sp_Mam_VentasEstadisticos(tipo As Nullable(Of Integer), fechaI As Nullable(Of Date), fechaF As Nullable(Of Date), yduact As String, vendedor As Nullable(Of Integer), cliente As Nullable(Of Integer), producto As Nullable(Of Integer), zona As Nullable(Of Integer)) As ObjectResult(Of sp_Mam_VentasEstadisticos_Result)
        Dim tipoParameter As ObjectParameter = If(tipo.HasValue, New ObjectParameter("tipo", tipo), New ObjectParameter("tipo", GetType(Integer)))
        ...
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of sp_Mam_VentasEstadisticos_Result)("sp_Mam_VentasEstadisticos", tipoParameter, fechaIParameter, fechaFParameter, yduactParameter, vendedorParameter, clienteParameter, productoParameter, zonaParameter)
    End Function
