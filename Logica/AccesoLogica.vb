...
#Region "Empleados"
    ...
    Public Shared Function L_Empleado_GeneralSimple(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Dim _Where As String
        If _Modo = 0 Then
            _Where = "cbnumi=cbnumi AND cenum=cbcat AND cecon=7 AND cbcat in (1,3) "
        Else
            _Where = "cbnumi=cbnumi AND cenum=cbcat AND cecon=7 AND cbcat in (1,3)" + _Cadena
        End If
...
#Region "TO004 Venta"
    ...
    Public Shared Function L_prListarPrecios() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 15))
        _listParam.Add(New Datos.DParametro("@ohuact", L_Usuario))
...
#Region "Prestamo de equipo vs ventas"
    ...
    Public Shared Function L_fnVentaGeneral(nomProveedor As String, FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@proveedor", nomProveedor))
        _listParam.Add(New Datos.DParametro("@fechaI", FechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", FechaF))
        _Tabla = D_ProcedimientoConParam("sp_go_Reportes", _listParam)
        Return _Tabla
