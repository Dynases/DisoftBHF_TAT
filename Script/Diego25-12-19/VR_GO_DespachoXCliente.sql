...
/****** Object:  View [dbo].[VR_GO_DespachoXCliente]    Script Date: 25/12/2019 18:37:20 ******/
SET ANSI_NULLS ON
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VR_GO_DespachoXCliente'
GO
