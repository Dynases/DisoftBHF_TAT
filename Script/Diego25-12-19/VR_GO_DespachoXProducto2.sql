...
/****** Object:  View [dbo].[VR_GO_DespachoXProducto2]    Script Date: 25/12/2019 18:36:53 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[VR_GO_DespachoXProducto2]
AS
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 12
         ...
         Alias = 900
         Table = 1170
         Output = ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VR_GO_DespachoXProducto2'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'720
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VR_GO_DespachoXProducto2'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VR_GO_DespachoXProducto2'
GO
