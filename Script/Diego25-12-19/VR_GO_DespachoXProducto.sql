...
/****** Object:  View [dbo].[VR_GO_DespachoXProducto]    Script Date: 26/12/2019 12:57:12 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        e.oaccbnumi, c.canumi, c.cacod, c.cadesc, c.cadesc2, d.cadesc AS categoria, SUM(b.obpcant) AS obpcant, f.chprecio, SUM(b.obpcant) * f.chprecio AS Total
...
WHERE        (a.oaest < 3)
GROUP BY e.oaccbnumi, c.canumi, c.cacod, c.cadesc, c.cadesc2, d.cadesc, f.chprecio
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 10
         ...
         Width = 1500
         Width = 1500
         Width = 234' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VR_GO_DespachoXProducto'
GO
